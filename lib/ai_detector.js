/**
 * Uncalibrated writing-pattern heuristic. It does not identify authorship.
 */
...
class AIDetector {
    ...
    static analyze(text) {
        ...
        let riskLevel = "Low Pattern Score";
        if (aiScore >= 65.0) riskLevel = "High Pattern Score";
        else if (aiScore >= 35.0) riskLevel = "Elevated Pattern Score";
        ...
        return {
            ...
            assessment_scope: "Uncalibrated writing-pattern heuristic; not evidence of AI or human authorship.",
            legacy_field_note: "ai_probability is retained as an API name; it is a heuristic score, not a calibrated probability."
        };
    }
}
